...
## Deploy app on GKE:
   ...
   * **Create Deployment**
    ...
    kubectl expose deployment nodeapp2 --type=NodePort --port 80 --target-port 3000
   ...
   * **for https:**
   ...
   <img width="333" alt="image" src="https://user-images.githubusercontent.com/58177069/211175341-1168208a-67b0-4d49-a064-f0d4ecd5f11a.png">
